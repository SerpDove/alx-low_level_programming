...
You are not allowed to use any variable of type char
File 100:Write a program that prints all possible different combinations of two digits.
...
You are not allowed to use any variable of type char
All your code should be in the main function
File 101:Write a program that prints all possible different combinations of three digits.
...
You are not allowed to use any variable of type char
All your code should be in the main function
File 102:Write a program that prints all possible combinations of two two-digit numbers.
